  ...
  return (
    <>
      <div className="relative bg-[#1B365D] text-white">
        <CommonContainer>
          <div className=" grid md:grid-cols-2 grid-cols-1 gap-8 lg:py-16 py-8 lg:px-0 px-6">
            <div className="space-y-6 lg:py-8 ">
              <h1 className="lg:text-5xl text-4xl font-bold lg:text-left text-center">
                Elevate your space and brand <span className="text-[#FFA500]">With Expert Designs</span>
              </h1>
              <p className="lg:text-lg lg:text-left text-center">
